...
// See: https://github.com/jckarter/selfaware

#ifndef autostruct_hpp
#define autostruct_hpp
...
#define AUTO_STRUCT_FIELD(fieldname) \
    ...
    struct fieldname { \
        template<typename U, typename ::autostruct::detail::enum_value_type<Q_T>::type N> \
        struct Q_enum { \
...
namespace autostruct {
    ...
    struct Struct : Fields... {
        ...
        static const int size = sizeof...(Fields);
